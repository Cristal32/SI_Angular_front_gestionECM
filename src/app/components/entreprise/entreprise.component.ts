...
export class EntrepriseComponent {
  ...
  setFormInCreatedEntreprise(){
    this.createdEntreprise.siret = this.form.siret;
    this.createdEntreprise.raison_social = this.form.raison_social;
    this.createdEntreprise.forme_juridique = this.form.forme_juridique;
    this.createdEntreprise.adrs_entreprise = this.form.adrs_entreprise;
    this.createdEntreprise.tel_standard = this.form.tel_standard;
    this.createdEntreprise.contact = this.form.contact;
    this.createdEntreprise.tel_contact = this.form.tel_contact;
  }
...
createEntrepriseForm(){
  ...
  console.log("createdTuteur: ", this.createdEntreprise);
...
deleteEntrepriseForm(){
  this.entrepriseService.deleteEntreprise(this.deletedEntreprise.siret).subscribe(
    data => {
      console.log(data);
      window.location.reload();
    },
  ...
  matchesSearchCriteria(entreprise: Entreprise, text: string): boolean {
    const searchFields: string[] = [
      entreprise?.siret.toLowerCase(),
      entreprise?.raison_social.toLowerCase(),
      entreprise?.forme_juridique.toLowerCase(),
      entreprise?.adrs_entreprise.toLowerCase(),
      entreprise?.tel_standard.toLowerCase(),
      entreprise?.contact.toLowerCase(),
      entreprise?.tel_contact.toLowerCase()
    ];
